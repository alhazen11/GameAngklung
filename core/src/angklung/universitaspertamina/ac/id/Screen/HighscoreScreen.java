...
public class HighscoreScreen  extends BaseScreen{
    ...
    public HighscoreScreen(final MainGame game, Song lagus) {
        super(game);
        if(game.tipe) {
    ...
    public void render(float delta) {
        ...
        switch (pilih){
            case 0:
                ...
                button[0] = new TextButton("Lir Ilir : " + nilai.load(7), textButtonStyle);
                button[0].setSize(300, 60);
                button[0].setPosition(Constants.WIDTH_H-50 - list.getWidth() + 15,Constants.HEIGHT_H-210);
                button[1] = new TextButton("Jaranan : "+ nilai.load(8), textButtonStyle);
            ...
            case 1:
                ...
                list.setPosition(Constants.WIDTH_H-50 - list.getWidth(),Constants.HEIGHT_H-50- list.getHeight());
                exit.setPosition(Constants.WIDTH_H-50 - list.getWidth() -exit.getWidth()/2,Constants.HEIGHT_H-30 -exit.getHeight());
                button[0] = new TextButton("Gundul Gundul Pacul : "+ nilai.load(4), textButtonStyle);
                button[0].setSize(300, 60);
                button[0].setPosition(Constants.WIDTH_H-50 - list.getWidth() + 15,Constants.HEIGHT_H-210);
                button[1] = new TextButton("Cublak Cublak Suweng : "+ nilai.load(5), textButtonStyle);
                button[1].setSize(300, 60);
                button[1].setPosition(Constants.WIDTH_H-50 - list.getWidth() + 15,Constants.HEIGHT_H-290);
                button[2] = new TextButton("Te Kate Dipanah : "+ nilai.load(6), textButtonStyle);
            ...
            case 2:
                ...
                list.setPosition(Constants.WIDTH_H-50 - list.getWidth(),Constants.HEIGHT_H-50- list.getHeight());
                exit.setPosition(Constants.WIDTH_H-50 - list.getWidth() -exit.getWidth()/2,Constants.HEIGHT_H-30 -exit.getHeight());
                button[0] = new TextButton("Manuk Dadali : "+ nilai.load(0), textButtonStyle);
                button[0].setSize(300, 60);
                button[0].setPosition(Constants.WIDTH_H-50 - list.getWidth() + 15,Constants.HEIGHT_H-210);
                button[1] = new TextButton("Es Lilin : "+ nilai.load(1), textButtonStyle);
                button[1].setSize(300, 60);
                button[1].setPosition(Constants.WIDTH_H-50 - list.getWidth() + 15,Constants.HEIGHT_H-290);
                button[2] = new TextButton("Tokeceng : "+ nilai.load(2), textButtonStyle);
                button[2].setSize(300, 60);
                button[2].setPosition(Constants.WIDTH_H-50 - list.getWidth() + 15,Constants.HEIGHT_H-370);
                button[3] = new TextButton("Cing Cangkeling : "+ nilai.load(3), textButtonStyle);
